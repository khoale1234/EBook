							...
							<div class="card crd-ho">
								<div class="card-body text-center">
									...
									<div class="row text-center p-1">
										<a href="book_detail.js p?bid=<%=b.getBookID() %>" class="btn btn-sm btn-success col-md-6 ml-5 ">View Details</a>
	...
	<div class="container">
		<h3 class="text-center">New Book	</h3>	
			<div class="row">
						...
						List<Book_dtls> list=bookImp2.getAllNewBook();
	...
	<div class="container">
		<h3 class="text-center">Old Book	</h3>	
			<div class="row">
						...
						List<Book_dtls> list3=bookImp2.getAllOldBook();
